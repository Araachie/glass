...
class ActionClassificationScore:
    ...
    @staticmethod
    def compute_ovo_results(actions: np.ndarray, vectors: np.ndarray, actions_count: int) -> Dict:
        """
        Computes statistics about the vectors associated with each action
    ...
    @staticmethod
    def compute_linear_results(actions: np.ndarray, vectors: np.ndarray, actions_count: int) -> Dict:
        """
        Computes statistics about the vectors associated with each action
    ...
    @staticmethod
    def compute_rbf_results(actions: np.ndarray, vectors: np.ndarray, actions_count: int) -> Dict:
        """
        Computes statistics about the vectors associated with each action
    ...
    @staticmethod
    def compute_poly_results(actions: np.ndarray, vectors: np.ndarray, actions_count: int) -> Dict:
        """
        Computes statistics about the vectors associated with each action
